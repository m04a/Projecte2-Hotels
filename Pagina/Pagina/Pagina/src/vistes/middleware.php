...
<html lang="en">
  ...
  <head>
   ...
   <!-- *** Capçalera inici *** -->
    ...
    La pagina que intentes accedir requereix iniciar sessió has iniciat sessió o no estas registrat, se té redigirà automaticament. <a href="login.php"> Si no redirigeix dona clic aqui </a>
    </div>
